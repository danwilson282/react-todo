...
const Form = () => {
    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
            <label>
                First Name : <input name="fname" type="text" value={state.fname} onChange={handleChange}></input>
            </label>
            <label>
                Last Name : <input name="lname" type="text" value={state.lname} onChange={handleChange}></input>
            </label>
            <label>
                Your Message : <textarea name="message" type="text" value={state.message} onChange={handleChange}></textarea>
            </label>
            <label>Car brand: <select name="carBrand" value={state.carBrand} onChange={handleChange}>
            ...
            <label>
                <input type="checkbox" name="isChecked" checked={state.isChecked} onChange={handleChange} />Is Checked?
            </label>
            <label>
